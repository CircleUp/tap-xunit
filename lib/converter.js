...
function converter(options) {
  ...
  tapParser.on('assert', function(assert) {
    ...
    if(options.testCaseClassName) {
        testCaseXml.att('classname', options.testCaseClassName)
    }
  ...
  function newTest(testName) {
    ...
    if(options.testCaseClassName) {
        testsuite.classname = options.testCaseClassName
    }
    curTestXml = rootXml.ele('testsuite', testsuite)
  }
